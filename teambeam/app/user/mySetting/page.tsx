...
import {
  ...
  Member,
  deleteAccount,
} from "@/app/_api/mySetting";
import ProfileImageModal, {
  ProfileImageModalProps,
} from "./_components/ChangeProfileImageModal";
import "./layout.scss";
...
const PrivateSetting = () => {
  ...
  const { screenMode, setScreenMode, initializeScreenMode } = useUserStore();
  ...
  useEffect(() => {
    ...
    const loadScreenMode = () => {
      ...
      if (savedScreenMode) {
        setScreenMode(savedScreenMode as "dark" | "light");
      } else {
      ...
      <div className='layoutContainer'>
        ...
        <div className='otherInfo'>
          <div className='profileImgArea'>
            ...
            <button className='changeImage' onClick={openModal}>
              프로필 이미지 변경하기
            </button>
          </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleMailChange(mail, setServerCode, accessToken)
                    }
                  >
                    코드 발급
                  </button>
          ...
          >
            <div className='passwordArea'>
              <div className='setting_box'>
                ...
                <button className='changePart' type='submit'>
                  비밀번호 변경하기
                </button>
              </div>
            </div>
